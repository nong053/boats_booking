        ...
        html+="<div class=\"box box-widget widget-user-2\">";
          ...
          html+="<div class=\"box-footer no-padding\">";
            html+="<ul class=\"nav nav-stacked\">";
              html+="<li style=\"background: #ecf0f5;\"><a href=\"#\">รหัส <span class=\"pull-right badge bg-blue\">CT"+indexEntry['vehicle_type_id']+"</span></a></li>";
             // html+="<li><a href=\"#\">จำนวนที่นั่ง <span class=\"pull-right badge bg-aqua\">5</span></a></li>";
